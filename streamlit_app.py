...
def send_to_api(message: str, chat_history: List[Dict]) -> str:
    ...
    try:
        ...
        response = session.post(
            ...
            json=payload,
            headers=headers,
            timeout=(30,60),  # Reduced timeout for faster failure detection
